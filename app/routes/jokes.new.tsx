...
export const action = async ({ request }: ActionArgs) => {
  ...
  // Check if content and name are strings
  ...
  // Validate content and name by checking if they are too short
  const fieldErrors = {
  ...
  // Using the form, an async function and redirect to create a new joke
  // allows us to not have to utilize React hooks like useEffect
